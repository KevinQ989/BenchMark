...
import { deleteRoutine, endWorkout, saveRoutine } from "@/utils/firestoreSaveUtils";
...
const RoutineScreen = () => {
	...
	const handleSaveRoutine = async () => {
		await saveRoutine(params.id, routineName, description, inputs, exercises)
	};

	const handleEndWorkout = async () => {
		await endWorkout(routineName, description, inputs, exercises, timer);
	};
	...
	const renderExercise = ({
		...
		return (
			<View style={styles.exerciseContainer}>
				...
				<ThemedText type="default" style={styles.gridColumn}>
					Sets
				</ThemedText>
				<ThemedText type="default" style={styles.gridColumnWide}>
					Weight (kg)
				</ThemedText>
				<ThemedText type="default" style={styles.gridColumnWide}>
					Reps
			...
			<FlatList
				...
				ListFooterComponent={
					<View>
						...
						<TouchableOpacity
							style={[styles.addButton, styles.aiButton]}
							onPress={() =>
								router.push({
								pathname: "/home/routine/aiRecommendations",
								params: {
									id: params.id,
									routineName: params.routineName,
									description: params.description,
						...
						>
							<Text style={styles.addText}>Get AI Recommendations</Text>
						</TouchableOpacity>
					</View>
				}
			/>
